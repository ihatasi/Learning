...
enc.to_cpu()
dis.to_cpu()
load_path = 'result/{}/gen_epoch_{}.npz'.format(args.method, args.epoch)
...
load_path = 'result/{}/dis_epoch_{}.npz'.format(args.method, args.epoch)
...
with chainer.using_config('train', False):
    ...
    L2 = F.mean_squared_error(f_x, f_rec_x)
    if args.method == "izif":
